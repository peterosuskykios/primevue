            ...
            <div class="flex flex-col">
                ...
                <div class="mb-6 flex flex-wrap gap-4">
                    <div>
                        ...
                        <label for="checkbox" class="text-surface-900 dark:text-surface-0 font-medium mr-20"> Remember Me </label>
                    </div>
                    <a class="text-surface-600 dark:text-surface-200 cursor-pointer hover:text-primary ml-auto transition-colors duration-300">Reset password</a>
                </div>
