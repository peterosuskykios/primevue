...
<template>
    ...
    <div class="px-8 min-h-screen flex justify-center items-center -mt-20 sm:mt-0">
        <div class="z-10 text-center">
            <div class="text-surface-900 dark:text-surface-0 font-bold text-8xl mb-6">Access Denied</div>
            <p class="leading-normal mt-0 mb-8 text-surface-700 dark:text-surface-100 text-xl font-medium">You don&lsquo;t have the permissions to access this page</p>
